...
class CobaController extends Controller
{
    ...
    public function otp(Request $request)
    {
        ...
        if ($get_token) {
            ...
            return response()
                ->json(['message' => 'welcome to home', 'access_token' => $token, 'token_type' => 'Bearer',]);
        } else {
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($userr)) {
            ...
            if ($user && $user->role === 'user') {
                ...
                return response()
                    ->json(['message' => 'welcome to home user', 'access_token' => $token, 'token_type' => 'Bearer', 'data' => $user->name , 'id' => $user->id]);
